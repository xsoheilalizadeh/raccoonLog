...
{
    public class PhysicalFileStore : IHttpLoggingStore, IDisposable
    {
#if NETCOREAPP2_2
        ...
        private readonly IOptions<PhysicalFileStoreOptions> _options;
        ...
        internal PhysicalFileStore(
            IOptions<RaccoonLogHttpOptions> logHttpOptions,
            IOptions<PhysicalFileStoreOptions> options
        )
        {
            _options = options;
...
#if NETCOREAPP2_2
        public PhysicalFileStore(IHostingEnvironment environment,
            IOptions<RaccoonLogHttpOptions> logHttpOptions,
            IOptions<PhysicalFileStoreOptions> options
...
#elif NETCOREAPP3_0 || NETCOREAPP3_1
        public PhysicalFileStore(IHostEnvironment environment,
            IOptions<RaccoonLogHttpOptions> logHttpOptions,
            IOptions<PhysicalFileStoreOptions> options
        ) : this(logHttpOptions, options)
        {
